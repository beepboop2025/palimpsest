...
<meta name="description" content="English translations of every Chinese-dominant title and bounded feed excerpt retained by Palimpsest, with original Chinese, provenance, and separate contextual notes.">
    ...
    return _json_bytes(
        {
            ...
            "description": "English translations of retained Chinese publisher metadata with original text and separate contextual notes.",
            "language": "en",
            "items": items,
        }
    )
...
def _rss_feed(rows: list[dict]) -> bytes:
    ...
    return (
        ...
        f'<link>{SITE}/news/china/english/</link><description>English translations of retained Chinese publisher metadata.</description><language>en</language>'
        + "".join(items)
        + "</channel></rss>\n"
    ).encode("utf-8")

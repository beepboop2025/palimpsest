...
CRITICAL_PATHS = (
    ...
    "assets/research-workspace/workspace.js",
    "assets/research-workspace/workspace.css",
    "assets/research-workspace/manifest.json",
    "scripts/build_market_workspace.py",
    "china/evidence/index.html",
    "assets/evidence-observatory.css",
    "assets/evidence-observatory.js",
    ...
    "collectors/china_mirror_trade.py",
    "collectors/china_publication_watch.py",
    "collectors/china_external_accounts.py",
    "processors/china_economic_history.py",
    "processors/china_mirror_trade.py",
    "processors/china_publication_watch.py",
    "processors/china_external_accounts.py",
    "scripts/build_china_evidence_observatory.py",
    "scripts/china_publication_watch_pull.py",
    "scripts/china_mirror_trade_pull.py",
    "scripts/china_external_accounts_pull.py",
    "config/china_mirror_trade.json",
    "config/china_publication_watch.json",
    "config/china_external_accounts.json",
    "china/economy/index.html",
    "china/economy/data.csv",
    "research/connected/index.html",
    "assets/economic-desk.css",
    ...
    "collectors/nbs_releases.py",
    "config/regional_economic_series.json",
    "processors/china_economic_health.py",
    "processors/connected_research.py",
    "scripts/build_china_economic_health.py",
    "scripts/build_connected_research.py",
    "scripts/china_economic_health_pull.py",
    "scripts/regional_economic_pull.py",
    "scripts/regional_research_pull.py",
    "ops/systemd/palimpsest-regional-research.service",
    "ops/systemd/palimpsest-regional-research.timer",

...
| **Censorship-practice dossiers** | Every qualifying captured post, article, or topic signal with evidence state, observed/reported mechanism, explicit actor attribution, timeline, exact-identity Palimpsest measurements, input hashes, counter-readings, unknowns, exclusions, and collector gaps | Every 6 hours | [`readings/censorship-practice-dossiers-latest.json`](readings/censorship-practice-dossiers-latest.json) |

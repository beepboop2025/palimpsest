...
| 3 | Public git history | Every refresh is a timestamped commit on a public repository. Rewriting served history requires a force-push, which is visible to anyone with a clone, a fork, or a fetched ref. | GitHub, plus everyone who ever cloned or forked. |
